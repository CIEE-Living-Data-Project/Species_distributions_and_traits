...
source(here("functions/zoop_traits_toolkit.R"))
...
Data source for zooplankton abundance and biomass data: https://open.canada.ca/data/en/dataset/2822c11d-6b6c-437e-ad65-85f584522adc

Data dictionary: https://pacgis01.dfo-mpo.gc.ca/FGPPublic/Zooplankton_Data_SoG/Data_dictionary_EN_FR_SoG_zooplankton_data_1996-2018.htm
```{r}
# The zooplankton abundance dataset from net observations
# TODO: reorder factor levels for traitID and traitName
zoop.SOG <- read.csv(here("data_inputs/Zoopl_SofG_1996-2018_EN.csv"),
                            check.names = F) %>% 
  # Rename some columns
...
head(unique(zoop.SOG$Genus_species))
...
save(zoop.SOG.meta, file = here("data_outputs/net_metadata.RData"))
